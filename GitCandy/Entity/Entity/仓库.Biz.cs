...
namespace NewLife.GitCandy.Entity
{
    ...
    public partial class Repository : Entity<Repository>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(Repository).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new Repository();
        //    entity.Name = "abc";
        //    entity.Enable = true;
        //    entity.IsPrivate = true;
        //    entity.AllowAnonymousRead = true;
        //    entity.AllowAnonymousWrite = true;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(Repository).Name, Meta.Table.DataTable.DisplayName);
        //}
