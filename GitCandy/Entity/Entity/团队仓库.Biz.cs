...
namespace NewLife.GitCandy.Entity
{
    ...
    public partial class TeamRepository : Entity<TeamRepository>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(TeamRepository).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new TeamRepository();
        //    entity.TeamID = 0;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(TeamRepository).Name, Meta.Table.DataTable.DisplayName);
        //}
