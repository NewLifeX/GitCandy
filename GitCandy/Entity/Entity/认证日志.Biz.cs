...
namespace NewLife.GitCandy.Entity
{
    ...
    public partial class AuthorizationLog : Entity<AuthorizationLog>
    {
        #region 对象操作
            ﻿
        ...
        public override void Valid(Boolean isNew)
        {
            ...
            if (!Dirtys[__.IssueIp]) IssueIp = WebHelper.UserHost;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(AuthorizationLog).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new AuthorizationLog();
        //    entity.AuthCode = "abc";
        //    entity.UserID = true;
        //    entity.IssueDate = DateTime.Now;
        //    entity.Expires = DateTime.Now;
        //    entity.IssueIp = "abc";
        //    entity.LastIp = "abc";
        //    entity.IsValid = true;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(AuthorizationLog).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <summary>根据认证码查找</summary>
        /// <param name="authcode">认证码</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static AuthorizationLog FindByAuthCode(String authcode)
        {
            if (Meta.Count >= 1000)
