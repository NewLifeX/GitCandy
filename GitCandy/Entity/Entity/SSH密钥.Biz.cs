...
namespace NewLife.GitCandy.Entity
{
    ...
    public partial class SshKey : Entity<SshKey>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(SshKey).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new SshKey();
        //    entity.UserID = true;
        //    entity.KeyType = "abc";
        //    entity.Fingerprint = "abc";
        //    entity.PublicKey = "abc";
        //    entity.ImportData = DateTime.Now;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(SshKey).Name, Meta.Table.DataTable.DisplayName);
        //}
